...
class ExploreCourse:
    def __init__(
        self, class_database: Dict[int, Set], course_category: Dict[str, Set]
    ) -> None:
        """_summary_
    ...
    def get_actions(
        self, quarter_index: int, remaining_units: int
    ) -> Set[Tuple[str, int]]:
        """_summary_
        ...
        Returns:
            Set[Tuple[str, int]]: _description_
        """

        raise Exception("Not Implemented yet")

    def get_quarter_cost(self, enrolled_courses: Set[Tuple[str, int]]) -> float:
        """_summary_
